...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://imgur.com/a/YTqdp7t.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '923400470983-923094733538@g.us',
    ...
    RG: process.env.RG || '923400470983-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'SK;KHANl11;0;https://imgur.com/a/YTqdp7t.jpeg;https://chat.whatsapp.com/Eeo2DAxu5ec4wrIoSxZhs5',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "SK KHAN",
    BOT_NAME: process.env.BOT_NAME || 'SK KHAN',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭Raju¹¹ꫂ;SK KHAN;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "923400470983",
